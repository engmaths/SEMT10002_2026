...
def calculate_mean(numbers):
	...
	#Typo here- was float (M) but should have been float(N). This caused a NameError.
...
def calculate_median(numbers):
	...
	#Comment is saying we should use //, but we just used /. This caused floating point division and thus a TypeError when we used we input an odd number of numbers
	median_index = (N // 2)
	numbers.sort()
